...
function createFourthQuizData() {
  return [
    createQuestion(
      ...
      ["RelativeLayout", "LinearLayout", "TableLayout", "a, b, c đều sai"],
      0,
    ),
    createQuestion(
      2,
      "Loại layout nào khuyến cáo không sử dụng?",
      ["AbsoluteLayout", "FrameLayout", "LinearLayout", "a, b, c đều sai"],
      0,
    ),
    createQuestion(
      3,
      "Một layout có thể chứa gì?",
    ...
    createQuestion(
      5,
      "Để tận dụng khoảng trống dư thừa trong LinearLayout, dùng thuộc tính gì?",
      [
    ...
    createQuestion(
      8,
      "Trong RelativeLayout, thuộc tính layout_above có nghĩa gì?",
      ["Trên view", "Dưới view", "Giữa", "Sai"],
      0,
    ),
    createQuestion(
      9,
      "Để kích thước widget chiếm toàn bộ vật chứa, dùng giá trị thuộc tính nào?",
      ["wrap_content", "match_parent", "fill_parent", "B và C"],
      3,
    ),
    createQuestion(
      10,
      "View nào sau đây có thể sử dụng trong cửa sổ ứng dụng Android?",
      ["Textbox", "TextView", "EditText", "B và C"],
      3,
    ),
    createQuestion(
      11,
      'Thuật ngữ "label" trong Android là widget nào?',
      ["EditText", "Spinner", "ListView", "TextView"],
      3,
    ),
    createQuestion(
      12,
      "RadioButton cần bao bọc bởi gì?",
      ["LinearLayout", "RadioGroup", "FrameLayout", "ScrollView"],
      1,
    ),
    createQuestion(
      13,
      "Với một tập lựa chọn nhỏ, ta thường dùng gì?",
      ["CheckBox", "ListView", "Spinner", "Tất cả đều đúng"],
      2,
    ),
    createQuestion(
      14,
      "Nội dung dài dùng view nào?",
      ["TextView", "ScrollView", "ListView", "GridView"],
      1,
    ),
    createQuestion(
      15,
    ...
    createQuestion(
      16,
      "Tiết kiệm không gian hiển thị danh sách, dùng gì?",
    ...
    createQuestion(
      17,
      "Native size là gì?",
      ["Widget size", "Kích thước gốc nội dung", "Layout size", "View size"],
      1,
    ),
    createQuestion(
      18,
      "Để thiết lập font, dùng cách nào?",
      ["android:typeface", "setTypeface()", "cả hai", "sai"],
      2,
    ),
    createQuestion(
      19,
      "Để kiểm soát sự kiện bên trong AutoCompleteTextView, ta cài đặt gì?",
      ["OnClickListener", "TextWatcher", "a và b sai", "a và b đúng"],
      1,
    ),
    createQuestion(
      20,
      "completionThreshold dùng để làm gì?",
      [
        "Kích hoạt danh sách đề nghị",
        "Chỉ định số ký tự tối thiểu để danh sách đề nghị xuất hiện",
        "Cả 2 đúng",
        "Cả 2 sai",
      ],
      1,
    ...
    createQuestion(
      21,
      "Khi cần tài nguyên hình ảnh, thêm vào thư mục nào?",
      ["menu", "layout", "drawable", "values"],
      2,
    ),
    createQuestion(
      22,
      "Sau khi thêm ảnh, truy xuất trong layout như thế nào?",
      ["@string/id", "@drawable/id", "cả 2 đúng", "cả 2 sai"],
      1,
    ),
    createQuestion(
      23,
      "Để sử dụng tài nguyên chuỗi trong XML, dùng cú pháp nào?",
      ["@drawable", "@string", "@text", "@value"],
      1,
    ),
    createQuestion(
      24,
      "Ta tạo thư mục font trong thư mục nào để thêm font mới?",
      ["values", "assets", "layout", "res"],
      1,
    ),
    createQuestion(
      25,
      "Khi phát triển ứng dụng trên phiên bản 4.x trở lên, dùng gì thay Gallery?",
      ["HorizontalScrollView", "VerticalScrollView", "cả 2 đúng", "cả 2 sai"],
      0,
    ),
    createQuestion(
      26,
      "Widget kế thừa từ lớp nào?",
      ["Layout", "View", "Activity", "Context"],
      1,
    ),
    createQuestion(
      27,
    ...
    createQuestion(
      28,
      "Thiết lập adapter dùng phương thức nào?",
      ["setAdapter()", "getAdapter()", "bindAdapter()", "attachAdapter()"],
      0,
    ),
    createQuestion(
      29,
      "setListAdapter dùng khi nào?",
      ["Mọi View", "ListActivity", "Không dùng", "Thay setAdapter"],
      1,
    ),
    createQuestion(
      30,
      "Xử lý click trong list-based widgets dùng gì?",
      [
    ...
    createQuestion(
      31,
      "BaseAdapter dùng để làm gì?",
      ["Xử lý click", "Layout", "Cung cấp dữ liệu custom", "Điều hướng"],
      2,
    ),
    createQuestion(
      32,
      "Khi muốn tùy biến list-based widget, ta cần kế thừa lớp nào?",
      ["Adapter", "ImageAdapter", "BaseAdapter", "ListAdapter"],
      2,
    ),
    createQuestion(
      33,
      "ArrayAdapter tham số thứ 3 là gì?",
      ["Context", "Layout", "Data source", "Listener"],
      2,
    ),
    createQuestion(
      34,
      "Model trong MVC là gì?",
      [
        "Tập hợp màn hình giao diện",
        "Interface listener",
        "Đối tượng và mã Java",
        "Layout XML",
      ],
      2,
    ),
    createQuestion(
      35,
      "Gắn XML với Activity dùng phương thức nào?",
      ["findViewById()", "setContentView()", "inflateView()", "bindView()"],
      1,
    ),
    createQuestion(
      36,
      "Một Activity có thể gọi setContentView mấy lần?",
      ["1", "2", "3", "không giới hạn"],
      3,
    ),
    createQuestion(
      37,
      "Lời gọi nào nằm giữa onCreate và onResume?",
      ["onDestroy", "onStop", "onStart", "onPause"],
      2,
    ),
    createQuestion(
      38,
      "Có thể dùng lệnh nào để khởi động Service từ ứng dụng Android?",
      ["runService", "startService", "createService", "bindService"],
      1,
    ),
    createQuestion(
      39,
      "ACTION_SET_ALARM cần permission gì?",
      [
        "Permission đặc biệt",
        "INTERNET permission",
        "Không cần permission",
        "ACCESS_ALARM permission",
      ],
      2,
    ),
    createQuestion(
      40,
      "Để xử lý việc chọn item trong context menu, override hàm nào?",
      [
    ...
    createQuestion(
      ...
      [
        "Chỉ định widget nào có context menu",
        "Xây dựng context menu",
        "Đăng ký context menu cho activity",
        "a b c đều sai",
      ],
      0,
    ),
    createQuestion(
      42,
      "Để thực hiện các thao tác cơ bản như trình duyệt thông thường, cung cấp gì?",
      ["Menu", "Activity mới", "Fragment", "tất cả đều đúng"],
      0,
    ),
    createQuestion(
      43,
      "Lưu trữ key-value trong Android dùng gì?",
      ["SQLite", "SharedPreferences", "Intent", "File Storage"],
      1,
    ),
    createQuestion(
      44,
      "Để truy cập SQLite để ghi, dùng phương thức nào?",
      [
        "getWritableDatabase()",
        "getReadableDatabase()",
        "getDatabase()",
    ...
    createQuestion(
      45,
      "Để đọc nội dung trong SD Card, cần permission nào?",
      [
    ...
    createQuestion(
      46,
      "Khai báo permission ở đâu?",
      ["Manifest", "Activity", "XML layout", "Gradle"],
      0,
    ),
    createQuestion(
      47,
    ...
    createQuestion(
      48,
      "Khi sử dụng widget trình duyệt (WebView), cần yêu cầu permission gì?",
      ["NETWORK", "INTERNET", "WIFI", "NONE"],
      1,
    ),
    createQuestion(
      49,
      "Widget trình duyệt trong Android có tên là gì?",
      ["BrowserView", "WebView", "HttpView", "PageView"],
      1,
    ),
    createQuestion(
      50,
    ...
    createQuestion(
      51,
      "Để bật JavaScript trong WebView, dùng gì?",
      ["enableJS()", "setJavaScriptEnabled(true)", "loadJS()", "startJS()"],
      1,
    ),
    createQuestion(
      52,
      "Để Android và trang HTML trao đổi thông tin, dùng gì?",
      [
        "browser.addScriptInterface()",
        "browser.setJavascriptInterface()",
    ...
    createQuestion(
      53,
      "ContentProvider được kích hoạt khi nào?",
      [
    ...
    createQuestion(
      54,
      "Các yêu cầu từ lớp ContentProvider được xử lý bằng phương thức nào?",
      ["Intent", "ContentResolver", "SQLite", "Service"],
      1,
    ),
    createQuestion(
      55,
      "Để kiểm tra thiết bị có tồn tại phần cứng hay không, dùng phương thức nào?",
      [
        "hasSystemFeature()",
        "checkSystemFeature()",
        "verifySystemFeature()",
    ...
    createQuestion(
      56,
      "Lớp nào xử lý chức năng Bluetooth?",
      ["adapter", "BluetoothAdapter", "Manager", "Matcher"],
      1,
    ),
    createQuestion(
      57,
      "Một loại dịch vụ do Android cung cấp giúp tạo giao diện người dùng là gì?",
      [
        "ActivityManager",
        "NotificationManager",
        "ContentProvider",
    ...
    createQuestion(
      60,
      "Trong Java, định nghĩa hằng số dùng từ khóa nào?",
