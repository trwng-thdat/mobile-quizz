...
function createThirdQuizData() {
  return [
    createQuestion(1, "Which company originally developed the Android operating system?", ["Microsoft", "Apple", "Android Inc.", "IBM"], 2),
    createQuestion(2, "Which component is responsible for managing the layout and positioning of items inside a RecyclerView?", ["Adapter", "ViewHolder", "LayoutManager", "DataManager"], 2),
    createQuestion(3, "Which company acquired Android Inc. in 2005?", ["Samsung", "Google", "Nokia", "Microsoft"], 1),
    createQuestion(4, "Which Android component is designed to efficiently display large datasets by recycling item views?", ["ListView", "RecyclerView", "GridLayout", "ScrollView"], 1),
    createQuestion(5, "What was the first commercially available Android smartphone?", ["Samsung Galaxy S", "HTC Dream", "Motorola Droid", "Nexus One"], 1),
    createQuestion(6, "Which type of data structure is commonly used as the data source for a ListView?", ["Array or List", "Stack", "Queue", "Tree"], 0),
    createQuestion(7, "In which year was the first Android version officially released?", ["2005", "2007", "2008", "2010"], 2),
    createQuestion(8, "Which attribute can be used to remove the divider line between ListView items?", ["android:dividerHeight = \"0dp\"", "android:noDivider = \"true\"", "android:listDivider = \"none\"", "android:hideDivider = \"true\""], 0),
    createQuestion(9, "Which mobile operating system was developed by Apple?", ["Android", "Windows Mobile", "iOS", "Symbian"], 2),
    createQuestion(10, "Which widget has largely replaced ListView in modern Android development?", ["ScrollView", "RecyclerView", "GridView", "FrameLayout"], 1),
    createQuestion(11, "Before the rise of Android and iOS, which mobile operating system was widely used in Nokia phones?", ["Symbian", "Palm OS", "Windows Phone", "BlackBerry OS"], 0),
    createQuestion(12, "Which Android component can be used to improve performance by recycling views in a ListView?", ["ViewHolder pattern", "Intent pattern", "Layout pattern", "Resource pattern"], 0),
    createQuestion(13, "What is the main programming language traditionally used for Android application development?", ["C#", "Java", "Swift", "Ruby"], 1),
    createQuestion(14, "Which method in an Adapter is responsible for creating/returning the view for each item in the list?", ["getItem()", "getView()", "getLayout()", "getListItem()"], 1),
    createQuestion(15, "Which of the following is the official IDE recommended for Android development?", ["Eclipse", "NetBeans", "Android Studio", "Visual Studio"], 2),
    createQuestion(16, "Which layout file is commonly used to define the appearance of each row in a ListView?", ["Row layout", "List layout", "Item layout", "Custom layout"], 2),
    createQuestion(17, "Android applications are typically distributed in which file format?", [".exe", ".jar", ".apk", ".app"], 2),
    createQuestion(18, "Which method is used to obtain a reference to a ListView defined in XML?", ["findListById()", "getListView()", "findViewById()", "loadList()"], 2),
    createQuestion(19, "Android operating system is primarily based on which kernel?", ["Windows Kernel", "Linux Kernel", "UNIX Kernel", "MacOS Kernel"], 1),
    createQuestion(20, "Which parameter in onItemClick() represents the position of the clicked item?", ["id", "position", "index", "itemNumber"], 1),
    createQuestion(21, "Which Android architecture layer provides the basic system functionality such as process management and memory management?", ["Application Framework", "Linux Kernel", "Android Runtime", "Applications"], 1),
    createQuestion(22, "Which method is called when a user selects an item in a ListView?", ["onItemClick()", "onClickItem()", "onListSelect()", "onViewClick()"], 1),
    createQuestion(23, "Which Android component is responsible for managing application resources such as strings and layouts?", ["Resource Manager", "Activity Manager", "Package Manager", "Window Manager"], 1),
    createQuestion(24, "Which listener is used to detect when a user clicks on an item in a ListView?", ["OnClickListener", "OnItemClickListener", "OnListClickListener", "OnSelectListener"], 1),
    createQuestion(25, "Which Android architecture component is responsible for managing application windows?", ["Activity Manager", "Window Manager", "Resource Manager", "Package Manager"], 1),
    createQuestion(26, "Which XML tag is used to declare a ListView in a layout file?", ["<List>", "<ListView>", "<ViewList>", "<ItemList>"], 1),
    createQuestion(27, "Which Android layer includes the libraries that support web browsing?", ["Application Framework", "Native Libraries", "Linux Kernel", "Applications"], 1),
    createQuestion(28, "Which method is used to assign an adapter to a ListView?", ["setData()", "setList()", "setAdapter()", "loadAdapter()"], 2),
    createQuestion(29, "Which library in Android is used to manage relational databases?", ["WebKit", "OpenGL", "SQLite", "Media Framework"], 1),
    createQuestion(30, "Which adapter is commonly used to display an array of strings in a ListView?", ["ArrayAdapter", "ListAdapter", "ViewAdapter", "DataAdapter"], 0),
    createQuestion(31, "Which Android architecture component is responsible for managing application permissions and installation?", ["Activity Manager", "Package Manager", "Window Manager", "Resource Manager"], 1),
    createQuestion(32, "Which class is commonly used to connect data to a ListView?", ["Controller", "Adapter", "Handler", "Provider"], 1),
    createQuestion(33, "Which Android architecture layer includes APIs used to build user interface components?", ["Native Libraries", "Linux Kernel", "Application Framework", "Android Runtime"], 1),
    createQuestion(34, "Which Android UI component is used to display a scrollable list of items?", ["GridLayout", "ListView", "LinearLayout", "TextView"], 1),
    createQuestion(35, "Which of the following Android libraries is mainly used for rendering 2D and 3D graphics?", ["SQLite", "OpenGL", "Media Framework", "SSL"], 1),
    createQuestion(36, "Which attribute can be used to limit the number of lines displayed in a TextView?", ["android:maxLines", "android:textLines", "android:limitLines", "android:maxText"], 1),
    createQuestion(37, "Which component is responsible for managing notifications in Android?", ["Notification Manager", "Activity Manager", "Package Manager", "Window Manager"], 1),
    createQuestion(38, "Which attribute controls the background color of a TextView?", ["android:textColor", "android:background", "android:color", "android:layoutColor"], 1),
    createQuestion(39, "Which Android architecture layer contains the system applications provided by the device manufacturer?", ["Native Libraries", "Android Runtime", "Applications", "Application Framework"], 1),
    createQuestion(40, "Which attribute is used to make the text in a TextView appear bold?", ["android:textStyle = \"bold\"", "android:textFormat = \"bold\"", "android:fontWeight = \"bold\"", "android:style = \"bold\""], 1),
    createQuestion(41, "Which Android library is mainly used for playing and recording audio and video?", ["Media Framework", "SQLite", "OpenGL", "WebKit"], 0),
    createQuestion(42, "Which method is used to change the text displayed in a TextView programmatically?", ["changeText()", "setText()", "updateText()", "modifyText()"], 1),
    createQuestion(43, "Which Android component manages the navigation between different application screens?", ["Window Manager", "Activity Manager", "Resource Manager", "Notification Manager"], 1),
    createQuestion(44, "Which attribute is used to align the text inside a TextView?", ["android:gravity", "android:layout_gravity", "android:textAlign", "android:position"], 1),
    createQuestion(45, "Which Android library is responsible for displaying web pages inside applications?", ["Media Framework", "SQLite", "WebKit", "OpenGL"], 1),
    createQuestion(46, "Which attribute is used to change the color of text in a TextView?", ["android:fontColor", "android:textColor", "android:color", "android:labelColor"], 1),
    createQuestion(47, "Which Android architecture layer provides the environment where Java/Kotlin code is executed?", ["Android Runtime", "Applications", "Linux Kernel", "Native Libraries"], 0),
    createQuestion(48, "Which attribute is used to change the size of the text in a TextView?", ["android:textStyle", "android:textSize", "android:fontSize", "android:labelSize"], 1),
    createQuestion(49, "Which Android system component provides access to device features such as camera, sensors, and GPS through standard APIs?", ["Hardware Abstraction Layer", "Activity Manager", "Package Manager", "Window Manager"], 0),
    createQuestion(50, "Which attribute is used to define the text displayed in a TextView?", ["android:value", "android:text", "android:label", "android:content"], 1),
    createQuestion(51, "Which Android component is mainly responsible for handling user interaction through a graphical interface?", ["Service", "Activity", "Broadcast Receiver", "Content Provider"], 1),
    createQuestion(52, "Which XML tag is used to create a TextView in an Android layout file?", ["<text>", "<TextView>", "<Text>", "<Label>"], 1),
    createQuestion(53, "Which Android component runs in the background without providing a user interface?", ["Activity", "Service", "Fragment", "Layout"], 1),
    createQuestion(54, "Which Android UI component is mainly used to display text to the user?", ["EditText", "TextView", "Button", "ImageView"], 1),
    createQuestion(55, "Which Android component is designed to respond to system-wide broadcast messages?", ["Activity", "Service", "Broadcast Receiver", "Content Provider"], 1),
    createQuestion(56, "Which attribute can be used to automatically focus the EditText when the activity starts?", ["android:focusable", "android:autoFocus", "android:focusableInTouchMode", "android:requestFocus"], 1),
    createQuestion(57, "Which Android component is primarily used to share data between different applications?", ["Activity", "Broadcast Receiver", "Service", "Content Provider"], 1),
    createQuestion(58, "Which method is used to display text programmatically inside an EditText?", ["setText()", "showText()", "displayText()", "writeText()"], 1),
    createQuestion(59, "Which mechanism is commonly used for communication between Android components?", ["Fragment", "Intent", "Layout", "Manifest"], 1),
    createQuestion(60, "Which attribute can be used to limit the maximum number of characters in an EditText?", ["android:maxLength", "android:textLimit", "android:length", "android:maxInput"], 1),
    createQuestion(61, "Which method is called first when an Activity is created?", ["onStart()", "onResume()", "onCreate()", "onPause()"], 1),
    createQuestion(62, "Which input type is commonly used for password fields in EditText?", ["textName", "textPassword", "textLogin", "textSecure"], 1),
    createQuestion(63, "Which Activity lifecycle method is called when the activity becomes visible to the user?", ["onCreate()", "onStart()", "onPause()", "onStop()"], 1),
    createQuestion(64, "Which attribute is used to define the type of input expected in an EditText (e.g., number, text, password)?", ["android:datatype", "android:inputType", "android:textMode", "android:dataInput"], 1),
    createQuestion(65, "Which method is called when the activity starts interacting with the user?", ["onStart()", "onResume()", "onCreate()", "onPause()"], 1),
    createQuestion(66, "Which method is used to convert the text from EditText into a String in Java?", ["getString()", "valueOf()", "convert()", "toString()"], 1),
    createQuestion(67, "Which lifecycle method is called when another activity comes in front and the current activity loses focus?", ["onStop()", "onCreate()", "onDestroy()", "onPause()"], 1),
    createQuestion(68, "Which method is used to retrieve the text entered by the user in an EditText?", ["getInput()", "getValue()", "readText()", "getText()"], 1),
    createQuestion(69, "Which lifecycle method is called when an activity is no longer visible to the user?", ["onPause()", "onStart()", "onStop()", "onResume()"], 1),
    createQuestion(70, "Which attribute is commonly used to display a hint message inside an EditText field?", ["android:message", "android:placeholder", "android:hint", "android:textHint"], 1),
    createQuestion(71, "Which lifecycle method is called before an activity is completely removed from memory?", ["onDestroy()", "onStop()", "onPause()", "onStart()"], 1),
    createQuestion(72, "Which XML tag is used to create an editable text field in Android?", ["<TextInput>", "<InputText>", "<EditText>", "<TextEditor>"], 1),
    createQuestion(73, "Which lifecycle method is called when a stopped activity is about to restart?", ["onRestart()", "onCreate()", "onResume()", "onPause()"], 1),
    createQuestion(74, "Which Android UI component allows the user to enter and edit text?", ["TextView", "EditText", "Button", "ImageView"], 1),
    createQuestion(75, "What is the main purpose of the Android Manifest file?", ["Designing UI layouts", "Declaring application components and permissions", "Writing Java code", "Storing application data"], 1),
    createQuestion(76, "Which attribute can be used to assign a click handler directly in an XML layout?", ["android:onClick", "android:clickEvent", "android:press", "android:event"], 1),
    createQuestion(77, "Which lifecycle method is typically used to initialize components such as buttons or text fields?", ["onPause()", "onStart()", "onCreate()", "onStop()"], 1),
    createQuestion(78, "Which type of button allows the user to toggle between two states (ON/OFF)?", ["ToggleButton", "RadioButton", "ImageButton", "FloatingButton"], 1),
    createQuestion(79, "Which lifecycle method is commonly used to release resources when the activity is no longer visible?", ["onPause()", "onStop()", "onCreate()", "onStart()"], 1),
    createQuestion(80, "Which type of button displays only an image instead of text?", ["ToggleButton", "ImageButton", "RadioButton", "SwitchButton"], 1),
    createQuestion(81, "What happens when the user presses the Back button while an activity is running?", ["The activity is paused only", "The activity is restarted", "The activity is destroyed and removed from the stack", "The activity is duplicated"], 1),
    createQuestion(82, "Which method is used to obtain a reference to a Button defined in an XML layout?", ["getButton()", "findViewById()", "getView()", "loadButton()"], 1),
    createQuestion(83, "What structure is used by Android to manage activities?", ["Activity Queue", "Activity List", "Activity Tree", "Activity Stack"], 1),
    createQuestion(84, "Which method is used to attach a click listener to a Button?", ["setListener()", "addClickListener()", "setOnClickListener()", "setClickHandler()"], 1),
    createQuestion(85, "When a new activity starts, what happens to the current activity?", ["It is deleted immediately", "It moves to the background and becomes paused", "It is restarted", "It becomes a service"], 1),
    createQuestion(86, "Which interface must be implemented to respond to a button click event programmatically?", ["View.OnClickListener", "Button.Listener", "ClickHandler", "EventListener"], 1),
    createQuestion(87, "Which Android component can continue running even if the application is not visible?", ["Activity", "Layout", "Service", "Fragment"], 1),
    createQuestion(88, "Which method is commonly used to handle a button click event in Android?", ["onTouch()", "onClick()", "onPress()", "onSelect()"], 1),
    createQuestion(89, "Which Android component does NOT provide a user interface?", ["Activity", "Broadcast Receiver", "Fragment", "View"], 1),
    createQuestion(90, "Which attribute is used to define the text displayed on a Button?", ["android:value", "android:text", "android:label", "android:caption"], 1),
    createQuestion(91, "What is the main purpose of a layout in an Android application?", ["To manage application permissions", "To manage application lifecycle", "To execute background tasks", "To define the structure and arrangement of UI elements"], 1),
    createQuestion(92, "Which XML tag is used to create a button in an Android layout file?", ["<text>", "<button>", "<Button>", "<btn>"], 1),
    createQuestion(93, "Which Android layout arranges its child views in a single row or column?", ["FrameLayout", "LinearLayout", "RelativeLayout", "TableLayout"], 1),
    createQuestion(94, "Which Android UI component is used to perform an action when the user taps it?", ["TextView", "ImageView", "Button", "EditText"], 1),
    createQuestion(95, "Which attribute is used in LinearLayout to specify the direction of arrangement?", ["android:gravity", "android:layout_gravity", "android:orientation", "android:alignment"], 1),
    createQuestion(96, "Which file format is commonly used to define layouts in Android applications?", ["JSON", "XML", "HTML", "YAML"], 1),
    createQuestion(97, "Which layout allows positioning UI elements relative to other elements?", ["LinearLayout", "FrameLayout", "RelativeLayout", "GridLayout"], 1),
    createQuestion(98, "Which Android layout allows elements to be aligned relative to the parent container?", ["RelativeLayout", "TableLayout", "FrameLayout", "LinearLayout"], 1),
    createQuestion(99, "Which layout is commonly used as a container for a single view or for overlapping views?", ["FrameLayout", "TableLayout", "LinearLayout", "ConstraintLayout"], 1),
    createQuestion(100, "Which layout attribute determines the background color of a view?", ["android:color", "android:textColor", "android:background", "android:style"], 1),
    createQuestion(101, "Which layout organizes its child views into rows and columns?", ["FrameLayout", "LinearLayout", "TableLayout", "RelativeLayout"], 1),
    createQuestion(102, "Which attribute defines the unique identifier for a view in a layout?", ["android:name", "android:key", "android:value", "android:id"], 1),
    createQuestion(103, "Which element is typically used inside TableLayout to define a row?", ["TableCell", "TableRow", "RowLayout", "GridRow"], 1),
    createQuestion(104, "Which layout is best suited for stacking views on top of each other?", ["LinearLayout", "FrameLayout", "TableLayout", "RelativeLayout"], 1),
    createQuestion(105, "Which layout provides the most flexible way to position views using constraints?", ["LinearLayout", "ConstraintLayout", "FrameLayout", "TableLayout"], 1),
    createQuestion(106, "What does the value wrap_content mean for layout width or height?", ["The view fills the entire screen", "The view size depends on its content", "The view is invisible", "The view overlaps other views"], 1),
    createQuestion(107, "Which Android layout can overlap its child views?", ["LinearLayout", "TableLayout", "FrameLayout", "GridLayout"], 1),
    createQuestion(108, "Which attribute is used to make a view occupy all available space in its parent layout?", ["wrap_content", "fill_parent", "match_parent", "layout_center"], 1),
    createQuestion(109, "Which layout attribute controls how a view is positioned within its parent layout?", ["android:layout_width", "android:layout_height", "android:layout_gravity", "android:text"], 1),
    createQuestion(110, "Which layout is recommended by Google for building complex and responsive UI designs?", ["LinearLayout", "FrameLayout", "ConstraintLayout", "TableLayout"], 1),
    createQuestion(111, "Which attribute is commonly used to specify spacing between views in a layout?", ["android:padding", "android:textColor", "android:background", "android:id"], 0),
    createQuestion(112, "Which Android layout allows views to be arranged in a grid-like structure?", ["GridLayout", "FrameLayout", "LinearLayout", "RelativeLayout"], 0),
    createQuestion(113, "What is the purpose of the Android ViewModel component?", ["To manage the UI components directly", "To store & manage UI-related data in a lifecycle-conscious way", "To handle database operations", "To manage network requests"], 1),
    createQuestion(114, "What does the 'WorkManager' in Android handle?", ["Managing UI updates in the background", "Scheduling background tasks that need to run even if the app is closed or the device is restarted", "Handling user input", "Managing database transactions"], 1),
    createQuestion(115, "What is the cat in Logcat?", ["Concatenate", "Content", "Communicate", "Category"], 1),
    createQuestion(116, "What supports Android for running various instances efficiently?", ["JVM", "DVM", "Compiler", "Emulator"], 1),
    createQuestion(117, "How do lifecycle-aware components help with managing resources in Android?", ["They perform background operations", "They manage memory by binding views automatically", "They save UI state across activity transitions", "They prevent memory leaks by observing lifecycle states"], 1),
    createQuestion(118, "Nine-patch image tool purpose in Android is ______ ?", ["Image Extension Tool", "Change Bitmap Images into Nine Sections", "Image Conversion Tool", "All Above"], 1),
    createQuestion(119, "Under which of the following Android is licensed?", ["OSS", "Sourceforge", "Apache/MIT", "None of the above"], 1),
    createQuestion(120, "APK stands for -", ["Android Phone Kit", "Android Page Kit", "Android Package Kit", "None of the above"], 1),
    createQuestion(121, "Which of the following converts Java byte code into Dalvik byte code?", ["Dalvik converter", "Dex compiler", "Mobile interpretive compiler (MIC)", "None of the above"], 0),
    createQuestion(122, "How can we stop the services in android?", ["By using the stopSelf() and stopService() method", "By using the finish() method", "By using system.exit() method", "None of the above"], 0),
    createQuestion(123, "How can we kill an activity in android?", ["Using finish() method", "Using finishActivity(int requestCode)", "Both (a) and (b)", "Neither (a) nor (b)"], 0),
    createQuestion(124, "ADB stands for -", ["Android debug bridge", "Android delete bridge", "Android destroy bridge", "None of the above"], 0),
    createQuestion(125, "On which of the following, developers can test the application, while developing the android applications?", ["Third-party emulators", "Emulator included in Android SDK", "Physical android phone", "All the above"], 1),
  ];
}
